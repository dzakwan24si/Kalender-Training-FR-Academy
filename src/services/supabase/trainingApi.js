...
const isMockMode = import.meta.env.VITE_SUPABASE_URL === undefined || import.meta.env.VITE_SUPABASE_URL.includes('placeholder');

// --- Mock Data for Demo Purposes ---
const mockNonReguler = [
  {
    id: 1, kategori_pelatihan: 'Teknis', jenis_pelatihan: 'Agronomi Dasar (Estate)', region: 'Riau', trainer: 'Budi Santoso', type_training: 'Offline', lokasi_training: 'TC Riau', start_date: '2026-08-10T09:00:00Z', end_date: '2026-08-12T17:00:00Z', total_batch: 45, target_total: 1500
  },
  {
    id: 2, kategori_pelatihan: 'Teknis', jenis_pelatihan: 'Operasional Mill', region: 'Kalbar', trainer: 'Andi', type_training: 'Offline', lokasi_training: 'Kalbar', start_date: '2026-08-15T09:00:00Z', end_date: '2026-08-18T17:00:00Z', total_batch: 34, target_total: 700
  },
  {
    id: 3, kategori_pelatihan: 'Soft Skill', jenis_pelatihan: 'Leadership', region: 'Kaltim', trainer: 'Citra', type_training: 'Online', lokasi_training: 'Kaltim', start_date: '2026-08-25T09:00:00Z', end_date: '2026-08-26T17:00:00Z', total_batch: 29, target_total: 400
  },
  {
    id: 4, kategori_pelatihan: 'Corporate', jenis_pelatihan: 'Budaya Perusahaan', region: 'Corporate', trainer: 'HR', type_training: 'Online', lokasi_training: 'HQ', start_date: '2026-09-02T09:00:00Z', end_date: '2026-09-02T17:00:00Z', total_batch: 2, target_total: 50
  },
  {
    id: 5, kategori_pelatihan: 'Administrasi', jenis_pelatihan: 'Finance 101', region: 'Riau', trainer: 'Tim Finance', type_training: 'Online', lokasi_training: 'Zoom', start_date: '2026-09-10T09:00:00Z', end_date: '2026-09-11T17:00:00Z', total_batch: 10, target_total: 150
  },
  {
    id: 6, kategori_pelatihan: 'Traksi', jenis_pelatihan: 'Maintenance Traksi', region: 'Kalbar', trainer: 'Eng', type_training: 'Offline', lokasi_training: 'TC Kalbar', start_date: '2026-09-20T09:00:00Z', end_date: '2026-09-24T17:00:00Z', total_batch: 15, target_total: 200
  }
];
